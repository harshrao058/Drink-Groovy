  ...
  return (
    <div>
      ...
      <div className="mx-auto  px-16 ">
        {/* Hero Map */}
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-32">
        ...
        {/* <div className="flex flex-col items-center gap-x-4 gap-y-4 py-16 md:flex-row">
          ...
          <div className="md:mt-o mt-10 w-full">
            <img
              src="://images.unsplash.com/photo-1605165566807-508fb529cf3e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80"
              alt="Getting Started"
