...
const SliderThree = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col md:flex-row items-center justify-between px-6 md:px-16 bg-[#77D479]">
      ...
      <img ref={imageRef} src={slide3} alt="" className="h-64 md:h-full" />
    </div>
  );
};
